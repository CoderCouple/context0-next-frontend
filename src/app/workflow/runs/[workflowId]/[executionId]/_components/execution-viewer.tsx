...
import { GetWorkflowPhaseDetailsAction } from "@/actions/workflow/get-workflow-phase-detail-action";
...
type ExecutionData = Awaited<
  ReturnType<typeof GetWorkflowExecutionWithPhasesAction>
>;
...
export default function ExecutionViewer({
  ...
  const phaseDetails = useQuery({
    ...
    queryFn: () => GetWorkflowPhaseDetailsAction(selectedPhase!),
  });
  ...
  const duration = DatesToDurationString(
    query.data?.completedAt ? new Date(query.data.completedAt) : null,
    query.data?.startedAt ? new Date(query.data.startedAt) : null
  );
